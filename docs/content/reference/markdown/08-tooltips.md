...
{{< tooltip "this," "best-practices/01-plan-content-development.md" >}} which links to an article on plan content 
development.

```md
{{</* tooltip "this," "best-practices/01-plan-content-development.md" */>}}
```
